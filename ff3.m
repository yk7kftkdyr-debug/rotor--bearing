function out = ff3(datafromvb,loadi,ttt1 )   % 求解 承载区  滚动体的1  3 两个方程组成的 方程组
...
for i=1:loadj              %包括了0号滚子，
     sita(i)=2*pi*(loadi(i))/n;   
     Q1(i)=0;Q2(i)=0;Q1e(i)=0;Q2e(i)=0; FP1e(i)=0;FP2e(i)=0; eQ2fenzi(i)=0; eQ2fenmu(i)=0;  
...
%*******************************考虑杂质影响的接触变形********************************************************** 
        %delta1k(i)=delta1(i)-ck+delta1kafa+delta1kbeita-oilh1(i)+ud ;    
        %delta2k(i)=delta2(i)-ck+delta2kafa+delta2kbeita-oilh2(i)+ud ;  
%*****************************************************************************************  

%********************************未考虑杂质影响的接触变形*********************************************************  
         delta1k(i)=delta1(i)-ck+delta1kafa+delta1kbeita-oilh1(i) ;    
         delta2k(i)=delta2(i)-ck+delta2kafa+delta2kbeita-oilh2(i) ; 
%*****************************************************************************************          
        if delta1k(i)<0
            Q1k=0;
         else
...
out.Ph1 = Ph1;
out.Ph2 = Ph2;
out.lengthcontact1 = lengthcontact1;
out.lengthcontact2 = lengthcontact2;
out.widthcontact1 = widthcontact1;
out.widthcontact2 = widthcontact2;
out.Fyindao = Fyindao;
out.fyindao = fyindao;
out.zuoyongjiao = zuoyongjiao;
out.oilh1 = oilh1;
out.oilh2 = oilh2;
out.delta1 = delta1;
out.delta2 = delta2;
